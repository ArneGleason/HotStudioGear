...
const adsCollection = defineCollection({
  ...
  schema: z.object({
    ...
    type: z.enum(['toronto', 'gary-banner', 'ktel', 'essentials', 'upgrade']).default('toronto'),
...
const cableEndsCollection = defineCollection({
  loader: glob({ pattern: '**/[^_]*.md', base: './src/content/cable-ends' }),
  schema: z.object({
    item_name: z.string(),
    category: z.string(),
    era: z.string(),
...
export const collections = {
  ...
  'cable-ends': cableEndsCollection,
};
